...
check "check for gcloud 463.0.0" gcloud --version | grep 'Google Cloud SDK 463.0.0'
check "check for kubectl v1.28.2" kubectl version --client | grep 'Client Version: v1.28.2'
check "check for helm v3.20.1" helm version --client | grep 'Version:"v3.20.1"'
